  ...
  <>
    ...
    <Section>
      <Container>
        ...
        <Text>
          {'After researching we realized this is a problem that plagues America as a whole, not just students, with over 46% of Americans not being able to cover $400 unexpected expenses and not having access to reasonably priced credit solutions. We believe that metrics used by Credit Bureaus to determine Credit Scores don’t accurately reflect one’s true credit-worthiness, given that employment offers verifying future streams of income could act as better indicators. This drove us to create SalaryMatch, which aims to use metrics that more accurately reflect an individual\'s true credit-worthiness, while employing a salary deduction structure for debt payment, greatly reducing default rates and allowing us to offer reasonably priced loans.'}
        </Text>
